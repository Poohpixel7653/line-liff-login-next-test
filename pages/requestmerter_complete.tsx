...
function Requestmerter_complete() {
      ...
      >
        <Row>
          {/* <Col span={24} style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                        <Col style={{backgroundColor:'#97B67F',width:'186px',height:'186px',borderRadius:'100px',display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                        <Image
                                src={success}
                                width={83.63}
                                height={64.31}
        ...
        <Row>
          ...
          >
            ขอบคุณที่แจ้งขอติดตั้งประปาครับ
          </Col>
        </Row>
        {/* <div>
...
export default Requestmerter_complete;
